...
target parameters. We will go through the following: 
...
#+RESULTS[<2021-11-25 08:10:30> eceb605fa0f7ede0e55b30ee62fd62ea8391b19b]:
: rx
:     Obs     Lev Lev+5FU 
:     305     294     289
...
distribution) and =formula.0= arguments (for the hazard of the
censoring distribution); note that for both we simply include main
...
distributions with functional form as specified by the =formula.1= and
=formula.2= arguments. As before, =formula.0= specifies the hazard of
the censoring distribution.  Note that we specified the model for the
cause-1 specific hazard with a squared effect of =nodes= and
...
We here show the code to apply our TMLE function to *the simulated
data* to target the real-valued parameter being the absolute risk of
cancer relapse after 3 years of follow-up under treatment with
...
#+RESULTS[<2021-11-25 08:18:01> ba1dc36541a4958b614f42ddad8b02e873381d17]:
:       F1 
: 0.271716

Notice that how the initial and the updated TMLE estimates each differ
from the true value; the initial estimator is biased due to the
...
#+RESULTS[<2021-11-25 08:24:40> e1369b712d18c66fb225564fad682e20a8e6fe99]:
#+begin_example
$init
$init$F1
         tau=1095.75
...
to compute simultaneous confidence intervals. (Notice, however, that
here this number is very close to 1.96, so there will not be much
difference between the simultaneous and the marginal confidence
intervals). \\

There are different options to how to run the one-step TMLE,
...
#+RESULTS[<2021-11-25 08:28:34> 7088f5443fe37114e8cce0086c39e74571f08762]:
#+begin_example
$init
$init$F1
         tau=1095.75
