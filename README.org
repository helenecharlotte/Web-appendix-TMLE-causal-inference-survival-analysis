...
- [[https://github.com/helenecharlotte/Web-appendix-TMLE-causal-inference-survival-analysis#on-the-initial-estimation][On the initial estimation]]
...
#+RESULTS[<2021-11-23 07:44:13> f2e3c33679841b2c807fb0fc388413195b470285]:
#+begin_example
$cox.model.1
$cox.model.1[[1]]
...
estimating equations estimator which, like the iterative TMLE,
produces estimates solving each efficient influence curve equation
separately, thus not guaranteed to yield compatible estimates for the
full survival curve.
